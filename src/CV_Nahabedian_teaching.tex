...
&Autores: L. Nahabedian, V. Braberman, N D'Ippolito, S. Honiden, J. Kramer, K. Tei, S. Uchitel\\
...
\subsection*{Participación en Conferencias Internacionales}
...
\begin{tabular}{L!{\VRule}R}
Jun 2015 & \textbf{Divulgador voluntario}, \textit{Semana de la computación}, FCEN, UBA\\
& Durante la semana de la computación me desenvolví como divulgador/organizador del evento que sucedió el 16, 17 y 18 de
junio del 2015. Dicho evento es el evento de divulgación más importante del Departamento de Computación. Me encargué de
...
Director & Sebastián Uchitel (Departamento de Computación, FCEN-UBA)\\
Puntaje & 8 puntos.\\
&Alumno de doctorado de LaFHIS (Laboratorio de Fundamentos y Herramientas para la Ingeniería del Software). No admitido
al doctorado aun.\\
\end{tabular}
