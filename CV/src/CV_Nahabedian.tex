...
\cventry{Ene 2015 actualidad}{Co-Director de Tesis de Licenciatura}{Universidad de Buenos Aires}{Argentina}{}{
Trabajando conjuntamente con Natalia Rodriguez. Licenciada y doctorando en ciencias de la computaci\'on UBA.
El autor de la tesis es Ivan Pasquini quien est\'a involucrandose en resolver problemas de s\'intesis de controladores con observaci\'on parcial.
\newline{}
El trabajo presentar\'a una soluci\'on novedosa para problemas donde se desconoce la totalidad de las 
propiedades del ambiente. La estrategia es explorar dicho ambiente de una manera inteligente para 
obtener solamente la informaci\'on necesaria para resolver el problema. Dicho trabajo tiene aplicaciones en la robotica,
en las redes de comunicaci\'on y otras.
}
